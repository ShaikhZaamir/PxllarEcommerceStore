...
export default async function FeaturedProducts() {
  ...
  // ✅ Fetch only products from the "featured-products" collection
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Handpicked favorites from our curated collection
            </p>
          </div>
          <Button
            variant="outline"
          ...
          >
            <Link href="/in/store?collection=featured-products">View All Products</Link>
          </Button>
        </div>
